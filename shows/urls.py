...
urlpatterns = [
    ...
    url(r'^(?P<show_id>[0-9]+)/vote_receiver/$', views.ShowVoteReceiverView.as_view(), name="show_vote_receiver"),
    ...
    url(r'^(?P<show_id>[0-9]+)/suggestion_pool/(?P<suggestion_pool_id>[0-9]+)/upvote_submit/$', views.UpvoteSubmitView.as_view(), name="upvote_submit"),
]